<template>
    <div class="row">
        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-4 q-pa-sm">
            ...
            >
                <q-card-section>
                    <span class="text-h6 text-bold">User's Word Consumptions</span><br/>
        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-6 q-pa-sm">
            ...
            >
                <q-card-section>
                    ...
                    >
                        <template v-slot:top-right>
                            <q-input borderless dense debounce="300" v-model="filterUnsub" placeholder="Search">
                            <template v-slot:append>
                                <q-icon name="search" />
                            </template>
                            </q-input>
                        ...
                        <template v-slot:body-cell-action="props">
                            <q-td :props="props">
                               <q-btn flat round color="black" icon="more_vert">
                                    <q-menu>
                                        <q-list style="min-width: 100px">
                                            <q-item clickable @click="manualyPaid(props.row.id)" v-close-popup>
                                                <q-item-section>Manual Paid Subscription</q-item-section>
                                            </q-item>
                                        </q-list>
                                    </q-menu>
                               </q-btn>
        ...
        <!-- <div class="col-12 col-xs-12 col-sm-12 col-md-3 q-pa-sm">
            <q-card class="my-card generatedDash" flat>
                <q-card-section horizontal>
                    <q-card-section class="col">
                        <span class="text-h6 text-bold text-blue-grey-10">User's Concerns</span><br/>
                        <span class="text-caption text-black">All reported issues found</span><br/>
                        <span class="text-h2 text-black">0</span><br/>
                    </q-card-section>
        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-3 q-pa-sm">
            <q-card class="my-card generatedDash2" flat>
                <q-card-section horizontal>
                    <q-card-section class="col">
                        <span class="text-h6 text-bold text-blue-grey-10">Online Users</span><br/>
                        <span class="text-caption text-black">Count of the online users</span><br/>
                        <span class="text-h2 text-black">0</span><br/>
                    </q-card-section>
        ...
        <q-dialog v-model="openAdjust" persistent>
            <q-card style="min-width: 350px">
                <q-card-section>
                <div class="text-h6">Adjust Word Cound Limit</div>
                </q-card-section>
