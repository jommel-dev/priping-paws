<template>
    <q-header class="transparentGradient">
      <q-toolbar>
        <q-toolbar-title> Grammar Web App </q-toolbar-title>
    ...
    <q-page-container>
        <div class="footer">
          <p class="text-h6"> this is sample footer</p>
        </div>
        <div class="footer">
          <p class="text-h6"> this is sample footer</p>
        </div>
...
import FeatureSection from 'src/components/Landing/featuresSections.vue'
